export const v3 = {
  "productName": "Invoice Reminder Playbook",
  ...
  "capabilities": [
    "Domain-specific workbench: Invoice Follow-up Ledger",
    "Operational table: Invoice ledger",
  ...
  "releaseChecklist": [
    ...
    "Cash At Risk reaches production threshold",
    "Aging Buckets is documented with evidence",
    "Tone Safety has no unresolved blocker",
    "Email/SMS drafts verified",
    "Collection plan verified",
    "CSV ledger verified"
  ],
  "operations": [
