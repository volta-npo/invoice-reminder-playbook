  ...
  "criteria": [
    {
      ...
      "prompt": "Implement and verify reminder sequence with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "tone-variants",
      "label": "Tone variants",
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify tone variants with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify payment status tracker with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify escalation checklist with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-quality",
